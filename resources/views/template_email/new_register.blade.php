...
@section('content') 
    ...
    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:18px;line-height:1.5em;margin-top:0;">
	    Congratulations!You have just successfully registered to Shopmonkey.club. Please verify your account by copying and pasting the code below:
