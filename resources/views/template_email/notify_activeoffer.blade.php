...
@section('content') 
    ...
    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:18px;line-height:1.5em;margin-top:0;">
		You have received this email to let you know that your schedule to active campaign offer is available, please continue your offer on or before {{$available_date}}
	</p>
