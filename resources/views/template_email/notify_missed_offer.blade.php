...
@section('content') 
    ...
    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:18px;line-height:1.5em;margin-top:0;">
		We regret to inform you that your schedule to purchase your product has passed. You might have been busy these past few days and have missed your scheduled offer. Please see the offer details below
	</p>
	...
	<tr style="padding:0">
        ...
        <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;line-height:1.5em;margin-top:0;text-align:left;font-size:12px">
          ...
          <br>
          <a rel="noopener noreferrer" href="mailto:support@reviewers.club" style="color:#00b2b2;text-decoration:none" target="_blank">support@reviewers.club</a>
       </td>
	</tr>
    </tbody>
	</table>
