...
<div class="col-sm-12">
       ...
       <div class="full-content2">
                         ...
                         <div class="contentarea2 active" id="step1">
                                @include('frontend.offerdetails_view.fullbuy_steps_template.step1')   
                         </div>
                         <div class="contentarea2" id="step2">
                                  @include('frontend.offerdetails_view.fullbuy_steps_template.step2')    
                          </div>
                          
                          <div class="contentarea2" id="step3">
                                  @include('frontend.offerdetails_view.fullbuy_steps_template.step3')
                          </div>
                          
                          <div class="contentarea2" id="step4">
                                 @include('frontend.offerdetails_view.fullbuy_steps_template.step4')
                          </div>
                          
                       <div class="contentarea2" id="step5">
                                @include('frontend.offerdetails_view.fullbuy_steps_template.step5')
                        </div>
                          
                      <div class="contentarea2" id="step6">
                                @include('frontend.offerdetails_view.fullbuy_steps_template.step6')
                      </div>
...
function setClasses2(index2, steps2) {
    ...
    */
    ...
    $(".step-wizard2 ul li").each(function() {
     ...
     /*
    $(".step-wizard2 ul li:lt(" + index2 + ")").each(function() {
      $(this).addClass("done");
    });
    */ 
