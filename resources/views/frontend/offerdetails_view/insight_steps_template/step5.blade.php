...
<form id='step5_data'  name='step5_data' >
  @csrf          
      <ol class="ol-circle">
            <li>
                <p>Compare this product to the other products you added to your list. Would you rather choose this product to be your best pick, second pick, third pick or worst pick? Why? </p> 
            ...
            <li class="mbm">
                <p>In your opinion, what should be improved on this product or the elements such as reviews, price, images, title or description that would make it more appealing?</p> 
                <div class="list-full-width">
                    <div class="mbl mtxl">
                        <div>
