	...
	<div class="form-group">
		...
		@endif
		 ...
		 @if( !empty($amazon_review_answers) && count($amazon_review_answers) > 0 )
			 <div class="col-lg-12">
			     <a href="#step-3" class="btn btn-primary backtostep3"><< back </a>
                  <a href="#step-5" class="btn btn-primary proceed_competed">next >></a>
            </div>
    	@endif
		...
		<script>
            ...
            {
              setClasses(5-1, $(".step-wizard ul li").length-1);
