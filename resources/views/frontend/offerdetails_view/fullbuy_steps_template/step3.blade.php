...
<div class="col-lg-12">
    ...
    <ol class="ol-circle">
        <li> On Amazon, search for the keyword <strong>{{$offerdetails[0]->fullbuy_keyword}} </strong> again.</li>
        <li>
            <p class="mbxl">Find the product with the display picture below:</p> 
            <p class="list-full-width text-center"> <img src="{{ cdn_asset('offer_images')}}/{{$images[0]->image_path}}" class="product-image"></p>
        </li>
        <li>
            ...
            <p class="mbl">
            Confirm the ASIN of the product
        ...
        <li> Once you have confirmed the product, add the product to your new list: </li>
      ...
      <div class="modal-body">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a data-toggle="collapse" href="#collapse-mobileapp">1: Find ASIN in the mobile app</a></h4>
                </div>
                <div id="collapse-mobileapp" class="panel-collapse collapse">
                    <div class="panel-body">
                        <p>Go to the product detail page and find the ASIN under the product information table.</p>
                        
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                                <img src="{{ asset('public/help_images/find-asin-mobileapp.png')}}" class="mtl width-100">
                            </div>
                        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a data-toggle="collapse" href="#collapse-mobile">2: Find ASIN in the mobile</a></h4>
                </div>
                <div id="collapse-mobile" class="panel-collapse collapse">
                    <div class="panel-body">
                        <p>Go to the product detail page and find the ASIN under the product information table.</p>
                       <div class="row">
                            <div class="col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                                <img src="{{ asset('public/help_images/find-asin-mobile.png')}}" class="mtl width-100">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a data-toggle="collapse" href="#collapse-desktop">3: Find ASIN in the desktop</a></h4>
                </div>
                <div id="collapse-desktop" class="panel-collapse collapse">
                    <div class="panel-body">
                        <p>Go to the product detail page and find the ASIN under the product information table.</p>
                        <img src="{{ asset('public/help_images/find-asin-desktop.png')}}" class="mtl width-100">
                    </div>
                </div>
            </div>
