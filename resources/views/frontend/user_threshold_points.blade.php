      ...
      <div class="row">
          <div class="col-md-9 col-xs-12">
            <div id="content-widget-component">
                <div>
                            <h2 class="font-20 text-uppercase text-stable-dark">Votes!</h2> 
                            The aim of voting is to provide your personal insights to the brands. By voting what you think
                            is the best choice, you provide your insights to the brands. With your input, brands can improve
                            their product and/or marketing. Check regularly for new Vote invites.
                </div>
       ...
       <div class="row">
            <div class="offerData2" style="display:block;">
                ...
                <div style="color:rgb(99, 107, 111);">
                    Sorry... No Votes Available At This Moment.
                </div>
                @endif
                    ...
                    <div id="{{@$val['id']}}">
            		    <div class="col-md-3">
                			...
                			<center><div class="photo_fix">
                			    ...
                			    @else
                			    <img class="img-responsive" alt="" src="{{asset('public/vote.jpg')}}" object-fit:="" contain="">
                			    @endif
                			    </div></center>
                			<div class="title_fix" style="margin-bottom: 15px;"><center><span class="title_fix_mod" style="font-size:18px;font-weight:600;"> Vote and Earn {{@$val['points']}} Points</span></center></div>
                			...
                			<div class="featured-box-price"> <span>Available Today</span> <span class="pull-right badge bg-grey" style="background-color:orange; font-weight: 200;">{{@$val['daily_votes']}}</span> </div>
                			<hr style="margin-top: 3px;margin-bottom: 3px;">
                			...
                			<div class="featured-box-price"><span><a href="javascript:void(0)" data-toggle="modal" data-target="#howvote_works">How does this work?</a></span></div><br>
                			@if(@$vote_threshold < 3)
                			<a href="{{asset('user/daily_thresholds/survey')}}/{{@$val['id']}}" style="width:100%" class="btn btn-default btn-flat">Vote & Earn Points</a>	
                			@else
                			<a href="javascript:void(0)" style="width:100%" class="btn btn-default btn-flat btn-not_vote">Vote & Earn Points</a>	
                			@endif
                			</div>
        		        </div>
                    </div>
