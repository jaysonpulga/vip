...
//$urlko = "https://tools.usps.com/go/TrackConfirmAction?tRef=fullpage&tLc=2&text28777=&tLabels='".$tracking_number."'";

/* 
$html =  file_get_html($urlko);
...
//echo json_encode(json_decode($articles));
