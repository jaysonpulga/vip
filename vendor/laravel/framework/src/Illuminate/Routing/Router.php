...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth(array $options = [])
    {
        ...
        if ($options['register'] ?? true) {
            ...
            $this->get('register', 'Auth\RegisterController@showInvitecode')->name('register');
            $this->post('register', 'Auth\RegisterController@register');
        }
        
        //Signup add jayson
         if ($options['signup'] ?? true) {
            //$this->get('signup/{code?}', 'Auth\RegisterController@showRegistrationForm')->name('signup');
            //$this->get('signup/application', 'Auth\RegisterController@signup_application')->name('signup');
           
               $this->get('invitecode', 'Auth\RegisterController@showInvitecode')->name('signup');
           
           $this->get('signup', 'Auth\RegisterController@showRegistrationForm')->name('signup');
           $this->get('signup/application/1', 'Auth\RegisterController@signup_application_1')->name('signup');
           $this->get('signup/application/2/{code?}/', 'Auth\RegisterController@showRegistrationForm')->name('signup');
